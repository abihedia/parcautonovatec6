...
class SaleMoveHeritbondecommande(models.Model):
    ...
    def curboncommande(self):
        ...
        print('sale_a_cree_bon_commande', sale_a_cree_bon_commande)
        for sale_bon_commande in sale_a_cree_bon_commande:
            if sale_bon_commande.devis_a_cree_commande == True:
                print('sale_bon_commande',sale_bon_commande)
            ...
            if sale_bon_commande.sale_periode == 1:
                if sale_bon_commande.sale_date_Facture + relativedelta(months=1) <= date.today()+relativedelta(days=1):
                    if sale_bon_commande.devis_a_cree_commande == True:
                        sale_vals = {
                        ...
                        print("bon de commande non update",purchase_id1)
            ...
            if sale_bon_commande.sale_periode == 3:
                if sale_bon_commande.sale_date_Facture + relativedelta(months=3) <= date.today()+relativedelta(days=1):
                    if sale_bon_commande.devis_a_cree_commande == True:
                        sale_vals = {
                            'company_id': sale_bon_commande.company_id.id,
                            'date_order': datetime.now(),
